...
gunicorn digcollretriever:app -k eventlet -w ${DIGCOLL_RETRIEVER_WORKERS:-4} -t ${DIGCOLL_RETRIEVER_TIMEOUT:-30} -b ${DIGCOLL_RETRIEVER_HOST:-0.0.0.0}:${DIGCOLL_RETRIEVER_PORT:-5000}
